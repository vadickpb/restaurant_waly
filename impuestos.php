...
<div class="row">
    <div class="col-lg-5">
        <div class="card">
            ...
            <h4 class="card-title text-white"><i class="fa fa-pencil"></i> Gestión de Impuestos</h4>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select name="statusimpuesto" id="statusimpuesto" class='form-control' required="" aria-required="true">
