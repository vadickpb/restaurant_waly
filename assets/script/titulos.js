...
document.title = '.:: SISTEMA DEL RESTAURANTE PICANTERIA WALY ::.';		
$(".current-year").text('2020 - ' + new Date().getFullYear() + ' CopyRight. Todos los Derechos Reservados - Vadick Palomino Bueno ');		
}); 
