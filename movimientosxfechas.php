    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-warning">
                <h4 class="card-title text-white"><i class="fa fa-search"></i> Movimientos por Fechas</h4>
            </div>
        ...
        <button type="button" onClick="BuscarMovimientosxFechas()" class="btn btn-warning"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
